...
handledemoUser(e){
    ...
    let demoUserEmail = 'baddude@aol.com'.split("");
    let demoPassword = 'siqqpuppy666'.split("")
    ...
    const animateLogin = () => {
        const int = setInterval(()=> {
            ...
            if (times < demoUserEmail.length){
                ...
                clearInterval(int);
                this.props.processForm({email: 'baddude@aol.com', password: 'siqqpuppy123'}).then(this.props.closeModal)
            }
        }, 30);
    }
animateLogin();
...
//     } 
   ...
   render(){
       ...
       if (this.props.formType === 'login'){
            disp = (<div> 
                By continuing, you agree to winterest's Terms of Service. 
                <br/>
                <br/>
                <div className="spanner">Not on winterest yet?  <div className="footer-button" onClick={this.props.otherForm}> Sign Up</div>
                </div>
            </div>) 
            buttontext = 'Sign Up'
       }
           ...
           disp = (<div>
               ...
               <br/> 
               <br/>
               <div className="spanner">Already on winterest?  <div className="footer-button" onClick={this.props.otherForm}> Log In</div>
               </div>
           </div>)
           buttontext = 'Log In'
       }
    ...
    return(
        ...
        <div className="form-all">
            ...
            <form className="signup-form" onSubmit={this.handleSubmit}>
                ...
                <div className="headerlogo">Welcome to WIN-terest!</div> 
                <h4 className="headersublogo">Home of winning chess strategy!</h4>
